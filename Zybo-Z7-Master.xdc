...
##Pmod Header JD                                                                                                                  
set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS33     } [get_ports { lcd_lines[0] }]; #IO_L5P_T0_34 Sch=jd_p[1]                  
set_property -dict { PACKAGE_PIN T15   IOSTANDARD LVCMOS33     } [get_ports { lcd_lines[1] }]; #IO_L5N_T0_34 Sch=jd_n[1]				 
set_property -dict { PACKAGE_PIN P14   IOSTANDARD LVCMOS33     } [get_ports { lcd_lines[2] }]; #IO_L6P_T0_34 Sch=jd_p[2]                  
set_property -dict { PACKAGE_PIN R14   IOSTANDARD LVCMOS33     } [get_ports { lcd_lines[3] }]; #IO_L6N_T0_VREF_34 Sch=jd_n[2]             
...
set_property -dict { PACKAGE_PIN V17   IOSTANDARD LVCMOS33     } [get_ports { lcd_rs_en[0] }]; #IO_L21P_T3_DQS_34 Sch=jd_p[4]             
set_property -dict { PACKAGE_PIN V18   IOSTANDARD LVCMOS33     } [get_ports { lcd_rs_en[1] }]; #IO_L21N_T3_DQS_34 Sch=jd_n[4]             
